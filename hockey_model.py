...
def build_player_form(shots_df):
    ...
    # --- detect truncated or partial shotWasOnGoal column
...
# ---------------------------------------------------------------
# Dummy context builders (unchanged)
# ---------------------------------------------------------------
